...
\preauthor{
\begin{center}}
  \postauthor{\ (\studentnumber)\\[0.3em]\small Github: \url{https://github.com/melikechan/blm4522} \\[0.3em]\small Video: \url{https://drive.google.com/file/d/1zFj4h6Ssi9lRxTPZcjtQdSX633QjR0VD}
\end{center}}
...
\begin{itemize}
  ...
  \item \textbf{pg\_dump / pg\_restore}: Mantıksal yedekleme araçları; özel format (\texttt{-Fc}) ve sıkıştırma (\texttt{-Z9}) desteği sunar.
  \item \textbf{pg\_basebackup}: Fiziksel temel yedek almak için kullanılır; artık yedeklemenin başlangıç noktasını oluşturur.
  \item \textbf{WAL (Write-Ahead Logging)}: Değişiklikleri önce günlük dosyasına yazan mekanizma; arşivleme ile PITR'ı mümkün kılar.
...
\section{Kimlik Doğrulama ve Yetkilendirme}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{1_full_backup}
  \caption{Tam yedekleme çıktısı}
  \label{fig:full-backup}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{2_incremental_backup}
  \caption{Artık yedekleme çıktısı — pg\_basebackup ve WAL arşivleme}
  \label{fig:incremental-backup}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{3_diff_backup}
  \caption{Fark yedekleme çıktısı — şema, veri ve tablo bazlı yedekler}
  \label{fig:diff-backup}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{5_1_diseaster_recovery}
  \caption{Felaket kurtarma — Senaryo 1 (DROP TABLE) ve Senaryo 2 (toplu DELETE)}
  \label{fig:dr1}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{5_2_diseaster_recovery}
  \caption{Felaket kurtarma — Senaryo 3 (yanlış UPDATE) ve Senaryo 4 (tam kayıp)}
  \label{fig:dr2}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{6_pitr_recovery}
  \caption{PITR kurtarma — geri yükleme noktası, felaket simülasyonu ve doğrulama}
  \label{fig:pitr}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{4_scheduled_backup}
  \caption{Zamanlanmış yedekleme — cron kurulumu ve otomatik betik}
  \label{fig:scheduled-backup}
\end{figure}
